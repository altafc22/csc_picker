            ...
            children: [
              Expanded(
                  child: Text(selected.toString(),
                      overflow: TextOverflow.ellipsis, style: selectedItemStyle != null ? selectedItemStyle : TextStyle(fontSize: 14))),
    ...
    textController.addListener(() {
      setState(() {
        if (textController.text.isEmpty) {
          ...
          filteredList =
              widget.items.where((element) => element.toString().toLowerCase().contains(textController.text.toLowerCase())).toList();
        }
      });
    });
    super.initState();
